        ...
        <div class="row">
            ...
            <div class="col-lg-9 relative">
                <div class="mb-10 flex items-center justify-between px-4">
                    <div class="space-y-1">
                        <h2 class="text-2xl font-black text-gray-900 tracking-tight">{{ $category->name }}</h2>
                        <p class="text-xs font-bold text-gray-400 uppercase tracking-widest">Tìm thấy <span id="total-products">{{ $listProduct->total() }}</span> sản phẩm</p>
                    </div>
